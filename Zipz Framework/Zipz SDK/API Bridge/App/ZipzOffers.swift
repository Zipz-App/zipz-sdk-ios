...
class ZipzOffers: ZipzSDK
{
    private let router = Router<AppAPI>()
    
    public func get(uuid: String, completion: @escaping (_ offer: Offer?, _ error: String?)->())
    {
            ...
            if let response = response as? HTTPURLResponse
            {
                ...
                case .success:
                    ...
                    do {
                        ...
                        debugLog("🧨 OFFER decode ERROR: \(error.userInfo)")
    ...
    public func reserve(uuid: String, completion: @escaping (_ offer: Offer?, _ error: String?)->())
    {
            ...
            if let response = response as? HTTPURLResponse
            {
                ...
                case .success:
                    ...
                    do {
                        ...
                        debugLog("🧨 RESERVE OFFER decode ERROR: \(error.userInfo)")
                        completion(nil, NetworkResponse.unableToDecode.rawValue)
                    }

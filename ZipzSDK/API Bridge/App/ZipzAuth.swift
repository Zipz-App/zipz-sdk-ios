...
class ZipzAuth
{
    ...
    func registerUser(with parameters: [String:Any], completion: @escaping (_ uuid: String?, _ error: String?)->())
    {
                ...
                switch result
                {
                    case .success:
                        ...
                        do {
                            ...
                            ZipzSDK.debugLog("🧨 Register decode ERROR: \(error.userInfo)")
    ...
    func initUser(with uuid: String, completion: @escaping (_ token: String?, _ error: String?)->())
    {
            ...
            switch result
            {
                case .success:
                    ...
                    do {
                        ...
                        ZipzSDK.debugLog("🧨 INIT decode ERROR: \(error.userInfo)")
                        completion(nil, NetworkResponse.unableToDecode.rawValue)
                    }
